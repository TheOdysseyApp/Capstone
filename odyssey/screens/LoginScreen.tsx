    ...
    return (
        <Screen preset="scroll">
            ...
            <View style={styles.inputContainer}>
                ...
                <Text style={{marginVertical: "5%"}}>Or log in with...</Text>
                ...
                <Text style={styles.registerText}>New to Odyssey? {<Text onPress={() => navigation.navigate("Register")} style={{textDecorationLine: 'underline', color: '#194260'}}>Register Here</Text>}</Text>
            </View>
        </Screen>
    )
}
