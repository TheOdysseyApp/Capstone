...
import QuestionnaireWhatInterestsYou from "./QuestionnaireWhatInterestsYou";


const bgImage = require("../../assets/where-are-you-traveling-to-bg.png")

const QuestionaireTravelingFrom = ({navigation}) => {
        ...
        <Screen preset="scroll">
            <ImageBackground source={bgImage} resizeMode={'cover'} style={{ flex: 1, height: '130%'}} >
                <SafeAreaView>
                    ...
                    <Button style={{ marginTop: "60%", justifyContent: 'center', marginLeft:40}} label="Next" onPress={() => navigation.navigate("QuestionnaireWhatInterestsYou")}/>
...
export default QuestionaireTravelingFrom;